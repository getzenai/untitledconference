...
CREATE INDEX "idx_oauth_access_token_session_id" ON "oauth_access_token" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_access_token_user_id" ON "oauth_access_token" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_access_token_refresh_id" ON "oauth_access_token" USING btree ("refresh_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_client_user_id" ON "oauth_client" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_consent_client_id" ON "oauth_consent" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_consent_user_id" ON "oauth_consent" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_refresh_token_client_id" ON "oauth_refresh_token" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_refresh_token_session_id" ON "oauth_refresh_token" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "idx_oauth_refresh_token_user_id" ON "oauth_refresh_token" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_passkey_user_id" ON "passkey" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_passkey_credential_id" ON "passkey" USING btree ("credential_id");